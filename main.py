...
if __name__ == "__main__":
    image = cv2.imread("E:/nmhcode/Yolov8-instance-seg-tensorrt/images/tp1/tp1/1.jpg")
    ...
    # plt.axis('off')
    # plt.title('Offical')
    cv2.imwrite("E:/imgsrc/image.jpg", image)
    # 直方图均衡增强
    image_equal_clo = hist(image)

    # plt.subplot(4, 2, 2)
    # plt.imshow(image_equal_clo)
    cv2.imwrite("E:/imgsrc/image_equal_clo.jpg", image_equal_clo)
    # plt.axis('off')
    ...
    cv2.imwrite("E:/imgsrc/image_lap.jpg", image_lap)
    # plt.axis('off')
    ...
    cv2.imwrite("E:/imgsrc/image_log.jpg", image_log)
    # plt.axis('off')
    ...
    cv2.imwrite("E:/imgsrc/image_gamma.jpg", image_gamma)
    # plt.axis('off')
    ...
    cv2.imwrite("E:/imgsrc/image_clahe.jpg", image_clahe)
    # plt.axis('off')
    # plt.title('CLAHE')
    ...
    cv2.imwrite("E:/imgsrc/image_ssr.jpg", image_ssr)
    # plt.axis('off')
    # plt.title('SSR')
    ...
    cv2.imwrite("E:/imgsrc/image_msr.jpg", image_msr)
    # plt.axis('off')
    # plt.title('MSR')
    #
    # plt.show()
